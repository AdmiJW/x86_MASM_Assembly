...
.data
	...
	box_title BYTE "Enter Hexagon side", 0
...
.code
lab4_1_challenge PROC

;	Part 1: Obtain user inputs
MOV EBX, OFFSET box_title

MOV EDX, OFFSET prompt_hex1
CALL MsgBox								;Challenge #1 - MsgBox prodedure
CALL WriteString
CALL ReadDec
MOV sideHex1, EAX
...
;	Part 4: Output
CALL Clrscr								;Challenge #2 - Clrscr prodecure
MOV EAX, lightRed+(black*16)			
CALL SetTextColor						;Challenge #3 - SetTextColor procedure
